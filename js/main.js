...
// const mainKey = "2555d2b81804e103ce3ea8c2dcccf93f"; // 高德开发者 Key
// const getWeather = () => {
...
// 弹窗
// function btn(){
//   floatqc.style.display = "block";
// }

// 在用户点击其他地方时，关闭弹窗
// window.onclick = function(event) {
//     if (event.target == floatqc) {
//         floatqc.style.display = "none";
//     }
// }
...
window.addEventListener("load", function () {
  window.addEventListener("resize", function () {
    ...
    if (window.innerWidth <= 990) {
      //移动端隐藏更多页面
      $("#container").attr("class", "container");
      $("#change").html("何日功成名遂了，还乡。");
      $("#change1").html("醉笑陪公三万场。");
